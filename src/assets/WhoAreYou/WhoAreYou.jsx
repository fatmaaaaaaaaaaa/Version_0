...
const WhoAreYou = () => {
    ...
    const handleJoinNow1 = () => {
        window.location.href = "/loginkid";
    };
    return (
        <>
            <div className={styles.main}>
                ...
                <div className={styles.selectionContainer}>
                    <div className={styles.selectionGroup}>
                        ...
                        />
                        <button className={styles.selectionButton} onClick={handleJoinNow}>Teacher</button>
                    </div>
                    <div className={styles.selectionGroup}>
                        <img
                            loading="lazy"
                        ...
                        />
                        <button className={styles.selectionButton} onClick={handleJoinNow1}>Kid</button>
                    </div>
                </div>
            </div>
        </>
